...
if(isset($_GET['Id']) && $_GET['Id'] != ""){
	$mdlRoom = $clsRoom->GetById($_GET['Id']);
}else{
...
if(isset($_POST['Name'])){
	...
	$err .= $clsFn->setForm('Name',$mdlRoom,true);
	$err .= $clsFn->setForm('Description',$mdlRoom,true);

	if($err == ""){
		$duplicate = $clsRoom->IsExist($mdlRoom);
		if($duplicate['val']){
			$msg .= '
			...
			<h6>Successfully Updated Room. </h6>
			</div>';
			$imgResult = $clsRoom->SetImage($_FILES["fileToUpload"],$mdlRoom->getId());
			if($imgResult['msg'] != ""){
				$msg .= '
				<div class="alert alert-danger alert-dismissible" role="alert">
				<button type="button" class="close" data-dismiss="alert" aria-label="Close">
  								...
  								<div class="panel-body">
  									<div class="row">
  										<div class="form-group col-md-12">
  											...
  											<input type="text" class="form-control" id="inputName" name="Name" placeholder="Name" value="<?php echo $mdlRoom->getName(); ?>" onblur="checkInput('inputName')">
  									...
  									<div class="row mb-2">
  										<div class="col-12">
  											...
  											<input type="text" class="form-control" id="inputDescription" name="Description" placeholder="Description" value="<?php echo $mdlRoom->getDescription(); ?>" onblur="checkInput('inputDescription')">
  											<small id="notif-inputName" class="invalid-feedback">This is required</small>
  										</div>
  									</div>
  									<div class="row mb-2">
