...
if(isset($_POST['Name'])){
	...
	$err .= $clsFn->setForm('Name',$mdlFloor,true);
	$err .= $clsFn->setForm('Description',$mdlFloor,true);

	if($err == ""){
		$duplicate = $clsFloor->IsExist($mdlFloor);
		if($duplicate['val']){
			$msg .= '
			...
			<h6>Successfully Updated Floor. </h6>
			</div>';
			$imgResult = $clsFloor->SetImage($_FILES["fileToUpload"],$mdlFloor->getId());
			if($imgResult['msg'] != ""){
				$msg .= '
				<div class="alert alert-danger alert-dismissible" role="alert">
				<button type="button" class="close" data-dismiss="alert" aria-label="Close">
  								...
  								<div class="panel-body">
  									<div class="row">
  										<div class="form-group col-md-12">
  											...
  											<input type="text" class="form-control" id="inputName" name="Name" placeholder="Name" value="<?php echo $mdlFloor->getName(); ?>" onblur="checkInput('inputName')">
  									...
  									<div class="row mb-2">
  										<div class="col-12">
  											...
  											<input type="text" class="form-control" id="inputDescription" name="Description" placeholder="Description" value="<?php echo $mdlFloor->getDescription(); ?>" onblur="checkInput('inputDescription')">
  											<small id="notif-inputName" class="invalid-feedback">This is required</small>
  										</div>
  									</div>
  									<div class="row mb-2">
