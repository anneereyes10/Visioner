...
if(isset($_GET['Id']) && $_GET['Id'] != ""){
	$mdlParts = $clsParts->GetById($_GET['Id']);
}else{
                ...
                <div class="panel-body">
                  ...
                  <div class="row">
                    <div class="form-group col-md-12">
                      ...
                      <p class="font-weight-bold"><?php echo $mdlParts->getName(); ?></p>
                    </div>
                  </div>
                  <div class="row mb-2">
                    <div class="col-12">
                      <label class="form-control-label" for="inputDescription">Description:</label>
                      <p class="font-weight-bold"><?php echo $mdlParts->getDescription(); ?></p>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-3 offset-sm-3">
                      <a href="EditParts.php?Id=<?php echo $mdlParts->getId(); ?>" id="submit" class="btn btn-primary w-100">Edit</a>
                    </div>
                    <div class="col-sm-3">
                      <a href="EditParts.php?Id=<?php echo $mdlParts->getId(); ?>" id="submit" class="btn btn-danger w-100" data-toggle="modal" data-target="#ModalWrapper" onclick="deleteShow(<?php echo $mdlParts->getId(); ?>);">Delete</a>
                    </div>
                  </div>
                </div>
              </div>
