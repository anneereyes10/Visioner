...
//to display on content box on index
function getPro()
{
	if(!isset($_GET['cat']))
	{
...
function getCatPro()
{
	if(isset($_GET['cat']))
	{
		$cat_id=$_GET['cat'];
			...
			if($count_cats==0)
			{
				echo "<h2 style='padding:20px;'>No products were found in this catergory!</h2>";
			}
...
function getBrandPro()
{
	if(isset($_GET['brand']))
	{
		$brand_id=$_GET['brand'];
			...
			if($count_brand==0)
			{
				echo "<h2 style='padding:20px;'>No brands were found in this catergory!</h2>";
			}
