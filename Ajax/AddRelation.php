...
function displayFloor($layoutId){
	...
	<div class="col-md-2 col-sm-3 mb-10 p-0">
		<a
			...
			onclick="showFloor(<?php echo $layoutId; ?>);"
			class="card shadow featured bg-light"
			style="color:#666;" id="Floor_Add"
		>
			<div class="card-body">
  ...
  $lstFR = $clsFR->GetByLayoutFloor_Id($layoutFloorId);
	...
	<div class="col-md-2 col-sm-3 mb-10 p-0">
		<a
			...
			data-toggle="modal"
			data-target="#ModalWrapper"
			onclick="showRoom(<?php echo $layoutFloorId; ?>);"
			class="card shadow featured bg-light"
			style="color:#666;" id="Room_Add"
		>
			<div class="card-body">
				<h5 class="card-title">Manage</h5>
				<p class="card-text">
  ...
  $lstRP = $clsRP->GetByFloorRoom_Id($floorRoomId);
	...
	<div class="col-md-2 col-sm-3 mb-10 p-0">
		<a
			...
			data-toggle="modal"
			data-target="#ModalWrapper"
			onclick="showPart(<?php echo $floorRoomId; ?>);"
			class="card shadow featured bg-light"
			style="color:#666;" id="Part_Add"
		>
			<div class="card-body">
				<h5 class="card-title">Manage</h5>
				<p class="card-text">
...
function displayMaterial($RoomPartId){
  ...
  $lstPM = $clsPM->GetByRoomPart_Id($RoomPartId);
	...
	<div class="col-md-2 col-sm-3 mb-10 p-0">
		<a
			...
			data-toggle="modal"
			data-target="#ModalWrapper"
			onclick="showMaterial(<?php echo $RoomPartId; ?>);"
			class="card shadow featured bg-light"
			style="color:#666;" id="Material_Add"
		>
			<div class="card-body">
				<h5 class="card-title">Manage</h5>
				<p class="card-text">
  ...
  foreach ($lstPM as $mdlPM) {
    ...
    <div class="col-md-2 col-sm-3 mb-10 p-0">
      <a
				href="javascript:void(0);"
				onclick="selMaterial(<?php echo $mdlPM->getId(); ?>);"
				class="card shadow featured bg-light"
				style="color:#666;"
...
function displayUpgrade($partMaterialId){
  ...
  $lstMU = $clsMU->GetByPartMaterial_Id($partMaterialId);
	...
	<div class="col-md-2 col-sm-3 mb-10 p-0">
		<a
			...
			data-toggle="modal"
			data-target="#ModalWrapper"
			onclick="showUpgrade(<?php echo $partMaterialId; ?>);"
			class="card shadow featured bg-light"
			style="color:#666;" id="Part_Add"
		>
			<div class="card-body">
  ...
  foreach ($lstMU as $mdlMU) {
    ...
    <div class="col-md-2 col-sm-3 mb-10 p-0">
      <a
				href="javascript:void(0);"
				onclick="selUpgrade(<?php echo $mdlMU->getId(); ?>);"
				class="card shadow featured bg-light"
				style="color:#666;"
				id="RoomPart_<?php echo $mdlMU->getId(); ?>"
			>
        <div
	        class="card-img-top img-featured"
	        style="background-image: url('<?php echo $imgLocation; ?>')"
